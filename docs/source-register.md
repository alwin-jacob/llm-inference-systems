...
| `stage2_experiment.py`, generated experiment/aggregate schemas, and complete 16 × 3 fixture | Final cardinality, manifest-link, comparison, eligibility, and reconstruction boundary | `SYNTHETIC_PROTOCOL_SHAPE_ONLY`; cannot establish or advance runtime/performance claims |
